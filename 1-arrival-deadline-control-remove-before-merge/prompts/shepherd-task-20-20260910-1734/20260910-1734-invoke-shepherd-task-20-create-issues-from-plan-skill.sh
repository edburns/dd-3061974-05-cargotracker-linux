#!/usr/bin/env bash
set -euo pipefail
timestamp=20260910-1734
log_dir_full=/home/edburns/workareas/dd-3061974-05-cargotracker-linux-shepherd-control/1-arrival-deadline-control-remove-before-merge/prompts/shepherd-task-20-20260910-1734
...
prompt_file=/home/edburns/workareas/dd-3061974-05-cargotracker-linux-shepherd-control/1-arrival-deadline-control-remove-before-merge/prompts/shepherd-task-20-20260910-1734/20260910-1734-invoke-shepherd-task-20-create-issues-from-plan-skill.md
